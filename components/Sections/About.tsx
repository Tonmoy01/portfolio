...
export default function About() {
  return (
    <section id='about' className='mb-16 animate-enter delay-150'>
      <div className='rounded-2xl bg-zinc-900/60 border border-zinc-800/50 p-8 md:p-12'>
        <div className='flex flex-col md:flex-row gap-10 items-center'>
          ...
          <div className='relative group shrink-0'>
            ...
            <div className='relative w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-2 border-zinc-700 bg-zinc-900'>
              <Image
          ...
          <div className='flex-1'>
            ...
            <div className='space-y-4 text-base leading-relaxed text-zinc-400'>
              <p>
                ...
                <span className='text-zinc-200'>PotentialAI</span> and{' '}
                <span className='text-zinc-200'>BulipeTech Ltd</span>,
              ...
              <p>
                ...
                <span className='text-zinc-200'>API integration</span>,
              ...
              <p>
                Focused on writing{' '}
                <span className='text-zinc-200'>clean architecture</span>,
                ...
                <span className='text-zinc-200'>freelance developer</span>.
              </p>
            </div>
            ...
            <div className='flex gap-3 mt-6'>
              <a
                ...
                className='inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-zinc-700 bg-zinc-800/50 text-zinc-200 text-sm font-medium hover:bg-zinc-700/50 hover:border-zinc-600 transition-all'
              >
